...
public sealed class GeometryConverter : IMultiValueConverter
{
    ...
    public static readonly GeometryConverter Border = new(Mode.Border);

    public static readonly GeometryConverter Ellipse = new(Mode.Ellipse);

    private readonly Mode _mode;

    private GeometryConverter(Mode mode) => _mode = mode;
