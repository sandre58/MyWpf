...
public static class RippleAssist
{
    ...
    public static readonly DependencyProperty IsCenteredProperty = DependencyProperty.RegisterAttached(
        "IsCentered", typeof(bool), typeof(RippleAssist), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.Inherits, IsCenteredChanged));
    ...
    private static void IsCenteredChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => MaterialDesignThemes.Wpf.RippleAssist.SetIsCentered(d, (bool)e.NewValue);
