// -----------------------------------------------------------------------
// <copyright file="HSVColor.cs" company="Stéphane ANDRE">
...
public readonly struct HSVColor : IEquatable<HSVColor>
{
    ...
    public override int GetHashCode() => A.GetHashCode() ^ Hue.GetHashCode() ^ Saturation.GetHashCode() ^ Value.GetHashCode();
