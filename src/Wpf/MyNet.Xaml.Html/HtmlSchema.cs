...
internal static class HtmlSchema
{
    ...
    {
        Debug.Assert(currentElementName.Equals(currentElementName, System.StringComparison.CurrentCultureIgnoreCase));
    ...
    internal static bool IsEntity(string entityName) =>
        ...
        _htmlCharacterEntities.Contains(entityName);
    ...
    /// </param>
    internal static char EntityCharacterValue(string entityName) => _htmlCharacterEntities.Contains(entityName) ? (char)_htmlCharacterEntities[entityName]! : (char)0;
    ...
    private static void InitializeInlineElements() => _htmlInlineElements =
        [
            "a",
            "abbr",
            "acronym",
    ...
    private static void InitializeBlockElements() => _htmlBlockElements =
        [
            "blockquote",
            "body",
            "caption",
    ...
    /// </summary>
    private static void InitializeElementsClosingOnParentElementEnd() => _htmlElementsClosingOnParentElementEnd =
        [
            "body",
            "colgroup",
            "dd",
    ...
    private static void InitializeElementsClosingOnNewElementStart()
    {
        ...
        _htmlElementsClosingThead =
        [
            "tbody",
            "tfoot"
        ];

        _htmlElementsClosingTfoot =
        [
            "tbody",
    ...
    /// </summary>
    private static void InitializeHtmlCharacterEntities() => _htmlCharacterEntities = new Hashtable
    {
        ["Aacute"] = (char)193,
        ["aacute"] = (char)225,
        ["Acirc"] = (char)194,
    ...
    private static ArrayList _htmlInlineElements = null!;

    private static ArrayList _htmlBlockElements = null!;

    private static ArrayList _htmlOtherOpenableElements = null!;

    // list of html empty element names
    private static ArrayList _htmlEmptyElements = null!;

    // names of html elements for which closing tags are optional, and close when the outer nested element closes
    private static ArrayList _htmlElementsClosingOnParentElementEnd = null!;
    ...
    private static ArrayList _htmlElementsClosingColgroup = null!;

    // names of elements closing the dd element
    private static ArrayList _htmlElementsClosingDD = null!;

    // names of elements closing the dt element
    private static ArrayList _htmlElementsClosingDT = null!;

    // names of elements closing the li element
    private static ArrayList _htmlElementsClosingLI = null!;

    // names of elements closing the tbody element
    private static ArrayList _htmlElementsClosingTbody = null!;

    // names of elements closing the td element
    private static ArrayList _htmlElementsClosingTD = null!;

    // names of elements closing the tfoot element
    private static ArrayList _htmlElementsClosingTfoot = null!;

    // names of elements closing the thead element
    private static ArrayList _htmlElementsClosingThead = null!;

    // names of elements closing the th element
    private static ArrayList _htmlElementsClosingTH = null!;

    // names of elements closing the tr element
    private static ArrayList _htmlElementsClosingTR = null!;

    // html character entities hashtable
    private static Hashtable _htmlCharacterEntities = null!;
