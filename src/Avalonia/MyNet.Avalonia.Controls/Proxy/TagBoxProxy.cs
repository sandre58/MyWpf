// -----------------------------------------------------------------------
// <copyright file="TagBoxProxy.cs" company="Stéphane ANDRE">
...
public sealed class TagBoxProxy : IControlProxy
{
    private readonly TagBox _control;

    public bool IsEmpty() => string.IsNullOrEmpty(_control.Text) && _control.Tags.Count == 0;
    ...
    public TagBoxProxy(TagBox control)
    {
        _control = control ?? throw new ArgumentNullException(nameof(control));
        _control.TagsChanged += TagsChanged;
    ...
    private void TagsChanged(object? sender, SelectionChangedEventArgs e)
    {
