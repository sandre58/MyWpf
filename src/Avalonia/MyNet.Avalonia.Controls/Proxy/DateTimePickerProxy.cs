// -----------------------------------------------------------------------
// <copyright file="DateTimePickerProxy.cs" company="Stéphane ANDRE">
...
public sealed class DateTimePickerProxy : IControlProxy
{
    ...
    public DateTimePickerProxy(DateTimePicker control)
    {
        _control = control ?? throw new ArgumentNullException(nameof(control));
        _ = DateTimePicker.SelectedDateProperty.Changed.Subscribe(e =>
        {
            if (e.Sender is not DateTimePicker dateTimePicker || dateTimePicker != _control)
                return;
