// -----------------------------------------------------------------------
// <copyright file="CalendarDatePickerDefaultProxy.cs" company="Stéphane ANDRE">
...
public sealed class CalendarDatePickerDefaultProxy : IControlProxy
{
    private readonly global::Avalonia.Controls.CalendarDatePicker _control;
    ...
    public CalendarDatePickerDefaultProxy(global::Avalonia.Controls.CalendarDatePicker control)
    {
        _control = control ?? throw new ArgumentNullException(nameof(control));
        _ = global::Avalonia.Controls.CalendarDatePicker.TextProperty.Changed.Subscribe(e =>
        {
            if (e.Sender is not global::Avalonia.Controls.CalendarDatePicker calendarDatePicker || calendarDatePicker != _control)
                return;
        ...
        _control.CalendarOpened += OnCalendarOpenedOrClosed;
        _control.CalendarClosed += OnCalendarOpenedOrClosed;
