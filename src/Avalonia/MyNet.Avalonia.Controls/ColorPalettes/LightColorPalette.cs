// -----------------------------------------------------------------------
// <copyright file="LightColorPalette.cs" company="Stéphane ANDRE">
...
public class LightColorPalette : IColorPalette
{
    ...
    public Color GetColor(int colorIndex, int shadeIndex) => Colors[colorIndex.SafeClamp(0, ColorCount - 1)][shadeIndex.SafeClamp(0, ShadeCount - 1)];
