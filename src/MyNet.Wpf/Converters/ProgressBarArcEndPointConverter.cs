// -----------------------------------------------------------------------
// <copyright file="ProgressBarArcEndPointConverter.cs" company="Stéphane ANDRE">
...
internal class ProgressBarArcEndPointConverter(bool inverse) : IMultiValueConverter
{
    public static readonly ProgressBarArcEndPointConverter Default = new(false);

    public static readonly ProgressBarArcEndPointConverter Inverse = new(true);

    private readonly bool _inverse = inverse;

    /// <summary>
    /// MyNet.Styles.ProgressBar.Circular draws two arcs to support a full circle at 100 %.
    ...
    public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        var degrees = (_inverse ? -360 : 360) * percent;
