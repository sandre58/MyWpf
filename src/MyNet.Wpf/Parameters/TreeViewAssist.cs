// -----------------------------------------------------------------------
// <copyright file="TreeViewAssist.cs" company="Stéphane ANDRE">
...
public static class TreeViewAssist
{
    ...
    public static void SetAdditionalTemplate(DependencyObject element, DataTemplate value) => element.SetValue(AdditionalTemplateProperty, value);
    ...
    /// </returns>
    public static DataTemplate GetAdditionalTemplate(DependencyObject element) => (DataTemplate)element.GetValue(AdditionalTemplateProperty);
    ...
    /// <param name="element">The element.</param>
    /// <param name="value">The value.</param>
    public static void SetAdditionalTemplateSelector(DependencyObject element, DataTemplateSelector value) => element.SetValue(AdditionalTemplateSelectorProperty, value);
    ...
    /// </returns>
    public static DataTemplateSelector GetAdditionalTemplateSelector(DependencyObject element) => (DataTemplateSelector)element.GetValue(AdditionalTemplateSelectorProperty);
