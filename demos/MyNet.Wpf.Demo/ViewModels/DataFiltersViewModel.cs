...
namespace MyNet.Wpf.Demo.ViewModels
{
    internal class DataFiltersViewModel : NavigableWorkspaceViewModel
    {
        public DataFiltersViewModel()
            => ItemsViewModel = new([.. EnumerableHelper.Range(0, RandomGenerator.Int(20, 200), 1).Select(_ => CreateRandomPerson())],
        ...
        private static PersonViewModel CreateRandomPerson()
        {
            ...
            var item = new PersonViewModel()
            {
                ...
                Country = RandomGenerator.ListItem(EnumClass.GetAll<Country>().ToList()),
                Birthdate = birthdate,
