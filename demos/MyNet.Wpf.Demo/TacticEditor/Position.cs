...
namespace MyNet.Wpf.Demo.TacticEditor
{
    public class Position : EnumClass<Position>, ISimilar<Position>
    {
        ...
        public static IEnumerable<Position> GetPlayerPositions()
            => [.. EnumClass.GetAll<Position>().Where(x => x.Side is PositionSide.Left or PositionSide.Right or PositionSide.Center).OrderBy(x => x.Value)];
