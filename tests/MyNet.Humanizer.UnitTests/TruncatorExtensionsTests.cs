...
public class TruncatorExtensionsTests
{
    [Theory]
    ...
    [InlineData("Text with length equal to truncate length", 41, "Text with length equal to truncate length")]
    [InlineData("Text smaller than truncate length", 34, "Text smaller than truncate length")]
    public void TruncateWithFixedLengthTruncator(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedLength));
    ...
    public void TruncateWithFixedNumberOfCharactersTruncator(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedNumberOfCharacters));
    ...
    public void TruncateWithFixedNumberOfWordsTruncator(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedNumberOfWords));
    ...
    public void TruncateWithTruncationString(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty()));
    ...
    [InlineData("Text with delimiter length greater than truncate length truncates to fixed length without truncation string", 2, "...", "Te")]
    [InlineData("Null truncation string? truncates to truncate length without truncation string", 4, null, "Null")]
    public void TruncateWithTruncationStringAndFixedLengthTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedLength));
    ...
    public void TruncateWithTruncationStringAndFixedNumberOfCharactersTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedNumberOfCharacters));
    ...
    public void TruncateWithTruncationStringAndFixedNumberOfWordsTruncator(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedNumberOfWords));
    ...
    [InlineData("Text with length equal to truncate length", 41, "Text with length equal to truncate length")]
    [InlineData("Text smaller than truncate length", 34, "Text smaller than truncate length")]
    public void TruncateWithFixedLengthTruncatorTruncateFromLeft(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedLength, TruncateFrom.Left));
    ...
    public void TruncateWithFixedNumberOfCharactersTruncatorTruncateFromLeft(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedNumberOfCharacters, TruncateFrom.Left));
    ...
    public void TruncateWithFixedNumberOfWordsTruncatorTruncateFromLeft(string? input, int length, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, Truncator.FixedNumberOfWords, TruncateFrom.Left));
    ...
    public void TruncateWithTruncationStringAndFixedLengthTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedLength, TruncateFrom.Left));
    ...
    [InlineData("Null truncation string? truncates to truncate length without truncation string", 4, null, "ring")]
    public void TruncateWithTruncationStringAndFixedNumberOfCharactersTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedNumberOfCharacters, TruncateFrom.Left));
    ...
    [InlineData("Text with whitespace at the end  ", 4, "...", "...whitespace at the end")]
    public void TruncateWithTruncationStringAndFixedNumberOfWordsTruncatorTruncateFromLeft(string? input, int length, string? truncationString, string? expectedOutput) => Assert.Equal(expectedOutput, input?.Truncate(length, truncationString.OrEmpty(), Truncator.FixedNumberOfWords, TruncateFrom.Left));
}
