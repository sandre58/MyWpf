// -----------------------------------------------------------------------
// <copyright file="TimeSpanHumanizeTests.cs" company="Stéphane ANDRE">
...
public class TimeSpanHumanizeTests
{
    ...
    [Theory]
    [InlineData(366L * 24 * 60 * 60 * 1000, "12 months", TimeUnit.Month)]
    [InlineData(6L * 7 * 24 * 60 * 60 * 1000, "6 weeks", TimeUnit.Week)]
    ...
    {
        var actual = TimeSpan.FromMinutes(minutes).Humanize(2, TimeUnit.Hour, TimeUnit.Minute);
    ...
    {
        var actual = TimeSpan.FromMilliseconds(milliseconds).Humanize(precision, collectionSeparator: ", ", lastSeparator: "and");
        Assert.Equal(expected, actual);
    }
